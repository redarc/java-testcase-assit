...
public class JcatTCGen
{
  ...
  protected final String TEXT_12 = "Module}." + NL + "     *" + NL + "     * @param testId                         - The test \"ID\", use the CTC if available.<br>" + NL + "     */" + NL + "     " + NL + "    @Parameters({\"testid\"})" + NL + "    " + NL + "    @Test" + NL + "    public void test (String testId) throws Exception {";
  protected final String TEXT_13 = NL + "        ";
  protected final String TEXT_14 = "Module testModule = ";
  protected final String TEXT_15 = "Module.newBuilder()" + NL + "            .setTestId(testId)" + NL + "            .build(); //Build a new instance of the test module." + NL + "        testModule.execute();" + NL + "    }" + NL + "}";
