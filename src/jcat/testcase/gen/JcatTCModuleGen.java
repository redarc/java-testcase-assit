...
public class JcatTCModuleGen
{
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import com.ericsson.ate.lte_ran_iov.testsupport.other.LteRm;" + NL + "import com.ericsson.ate.lte_ran_iov.testsupport.tool.uetools.ueinterfaces.UeNasMode;" + NL + "import com.ericsson.msr.handlers.EnbConfigHandlerBuilder;" + NL + "import com.ericsson.msr.handlers.EnbHandler;" + NL + "import com.ericsson.msr.handlers.UeHandler;" + NL + "import com.ericsson.msr.handlers.UeNasModeBuilders;" + NL + "import com.ericsson.msr.handlers.enums.Direction;" + NL + "import com.ericsson.msr.handlers.enums.Protocol;" + NL + "import com.ericsson.msr.handlers.enums.UeCategory;" + NL + "import com.ericsson.msr.testhelpers.EnbTestHelper;" + NL + "import com.ericsson.tac.jcat.TestBase;" + NL + "/**" + NL + " *   " + NL + " * @name ";
