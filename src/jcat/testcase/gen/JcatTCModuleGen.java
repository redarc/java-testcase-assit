...
public class JcatTCModuleGen
{
  ...
  protected final String TEXT_4 = " extends TestBase{" + NL + "" + NL + "    @SuppressWarnings(\"serial\")" + NL + "    private final HashMap<String, String> SysConstMap = new HashMap<String, String>(){" + NL + "        {" + NL + "        put(\"\", \"\");" + NL + "        }" + NL + "    };" + NL + "    " + NL + "    private String testId = null;" + NL + "    private String description = null;" + NL + "    private int duration = 0;" + NL + "    private String servingEUtranCell = null;" + NL + "    private int ue_TotalNumber = 1;" + NL + "    private int ue_TputNumber = 1;" + NL + "    " + NL + "    // Cell parameters" + NL + "    private int cellCapRrcConnSetupReq = 0;" + NL + "    " + NL + "    private int[] eUtranCellId;" + NL + "    private boolean isTDD = false;" + NL + "    " + NL + "    private UeNasMode ueNasMode;" + NL + "    private EnbHandler enbHandler;" + NL + "    private EnbTestHelper enbTestHelper;" + NL + "    private EnbConfigHandlerBuilder enbOriginalConfig;" + NL + "    " + NL + "    public static ";
